...
q/y : increase/decrease max speeds by 5%
CTRL-C to quit
"""
...
class DuckietownWorldEvaluatorHumanBaseline(DuckietownWorldEvaluator):
    ...
    def countdown(self, t):
        ...
        while t:
            ...
            timer = '{:02d}:{:02d} remaining to restart.'.format(mins, secs)
            print(timer, end="\r")
            time.sleep(1)
            t -= 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--player", help="Input the player name for the leaderboard.", type=str, default="anonymous")
    ...
    if args.test == "yes":
        ...
        test = False
        results_path = "human_baseline/final/"+ name + "/" + evaluate_map + "_" + str(SEED) + "_evaluate_gym_duckietown"
        run_episodes = 3
