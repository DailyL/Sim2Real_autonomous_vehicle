...
"""autogenerated by genpy from duckietown_msgs/DiagnosticsRosParameterArray.msg. Do not edit."""
import codecs
import sys
...
class DiagnosticsRosParameterArray(genpy.Message):
  _md5sum = "3cce38c64acfe087a9363ff4d78b53a5"
  _type = "duckietown_msgs/DiagnosticsRosParameterArray"
...
bool editable       # Editable (it means that the node will be notified for changes)"""
  ...
  _slot_types = ['std_msgs/Header','duckietown_msgs/NodeParameter[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DiagnosticsRosParameterArray, self).__init__(*args, **kwds)
