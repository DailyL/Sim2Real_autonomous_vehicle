...
(cl:defmethod cl:initialize-instance :after ((m <Vsample>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vsample)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name duckietown_msgs-msg:<Vsample> is deprecated: use duckietown_msgs-msg:Vsample instead.")))
...
(cl:defmethod x_axis_pose_delta-val ((m <Vsample>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader duckietown_msgs-msg:x_axis_pose_delta-val is deprecated.  Use duckietown_msgs-msg:x_axis_pose_delta instead.")
  (x_axis_pose_delta m))

(cl:ensure-generic-function 'y_axis_pose_delta-val :lambda-list '(m))
(cl:defmethod y_axis_pose_delta-val ((m <Vsample>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader duckietown_msgs-msg:y_axis_pose_delta-val is deprecated.  Use duckietown_msgs-msg:y_axis_pose_delta instead.")
  (y_axis_pose_delta m))
