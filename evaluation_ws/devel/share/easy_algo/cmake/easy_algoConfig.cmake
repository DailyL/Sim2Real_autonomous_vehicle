...
if("TRUE" STREQUAL "TRUE")
  set(easy_algo_SOURCE_PREFIX /home/dianzhao/real_duckie_catkin_ws/src/easy_algo)
  set(easy_algo_DEVEL_PREFIX /home/dianzhao/real_duckie_catkin_ws/devel)
  ...
  set(easy_algo_INSTALL_PREFIX /home/dianzhao/real_duckie_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'easy_algo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dianzhao/real_duckie_catkin_ws/src/easy_algo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT easy_algo_NUM_DUMMY_TARGETS)
      set(easy_algo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::easy_algo::wrapped-linker-option${easy_algo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR easy_algo_NUM_DUMMY_TARGETS "${easy_algo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::easy_algo::wrapped-linker-option${easy_algo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND easy_algo_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(easy_algo_EXPORTED_TARGETS ${${easy_algo_dep}_EXPORTED_TARGETS})
endforeach()
