...
echo_and_run cd "/home/dianzhao/real_duckie_catkin_ws/src/explicit_coordinator"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dianzhao/real_duckie_catkin_ws/src/explicit_coordinator/setup.py" \
     \
    build --build-base "/home/dianzhao/real_duckie_catkin_ws/build/explicit_coordinator" \
    install \
    --root="${DESTDIR-/}" \
