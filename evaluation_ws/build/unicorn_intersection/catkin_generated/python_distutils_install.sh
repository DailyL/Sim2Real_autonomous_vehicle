...
echo_and_run cd "/home/dianzhao/real_duckie_catkin_ws/src/unicorn_intersection"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dianzhao/real_duckie_catkin_ws/src/unicorn_intersection/setup.py" \
     \
    build --build-base "/home/dianzhao/real_duckie_catkin_ws/build/unicorn_intersection" \
    install \
    --root="${DESTDIR-/}" \
