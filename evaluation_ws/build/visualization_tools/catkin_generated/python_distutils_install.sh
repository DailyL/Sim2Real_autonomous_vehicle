...
echo_and_run cd "/home/dianzhao/real_duckie_catkin_ws/src/visualization_tools"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dianzhao/real_duckie_catkin_ws/src/visualization_tools/setup.py" \
     \
    build --build-base "/home/dianzhao/real_duckie_catkin_ws/build/visualization_tools" \
    install \
    --root="${DESTDIR-/}" \
