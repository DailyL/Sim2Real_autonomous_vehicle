...
results_path = "rl_agent/LSTM_SAC/overtaking/" + evaluate_map + "_" + str(SEED) + "_evaluate_gym_duckietown"
...
if __name__ == "__main__":
    ...
    agent_name = "SAC" 
    actor_weights = os.getcwd() + "/experiments" + "/" + "SAC_Duckie_Gazebo__2023-04-16_67805/" + agent_name + "_actor_weights.pth"
    critic_weights = os.getcwd() + "/experiments" + "/" + "SAC_Duckie_Gazebo__2023-04-16_67805/" + agent_name + "_critic_weights.pth"
    # read config file
