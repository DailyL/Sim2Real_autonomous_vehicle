...
echo_and_run cd "/home/dianzhaoli/duckie_catkin_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/dianzhaoli/duckie_catkin_ws/build/vision_opencv/cv_bridge \
    build --build-base "/home/dianzhaoli/duckie_catkin_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
