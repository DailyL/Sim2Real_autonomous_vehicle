...
echo_and_run cd "/home/dianzhaoli/duckie_catkin_ws/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/dianzhaoli/duckie_catkin_ws/build/vision_opencv/image_geometry \
    build --build-base "/home/dianzhaoli/duckie_catkin_ws/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
