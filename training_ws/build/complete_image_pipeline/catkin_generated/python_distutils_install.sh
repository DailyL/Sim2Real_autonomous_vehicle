...
echo_and_run cd "/home/dianzhaoli/duckie_catkin_ws/src/complete_image_pipeline"
...
echo_and_run /usr/bin/env \
    ...
    "/home/dianzhaoli/duckie_catkin_ws/src/complete_image_pipeline/setup.py" \
     \
    build --build-base "/home/dianzhaoli/duckie_catkin_ws/build/complete_image_pipeline" \
    install \
    --root="${DESTDIR-/}" \
