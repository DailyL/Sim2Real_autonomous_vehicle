...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<FSMState>)))
  ...
  "7358237ec6ffa8d862869f9b95659ac9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'FSMState)))
  "Returns md5sum for a message object of type 'FSMState"
  "7358237ec6ffa8d862869f9b95659ac9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FSMState>)))
  ...
  (cl:format cl:nil "Header header~%string state~%~%# pseudo constants~%string LANE_FOLLOWING=\"LANE_FOLLOWING\"~%string COORDINATION=\"COORDINATION\"	~%string INTERSECTION_CONTROL=\"INTERSECTION_CONTROL\"~%string JOYSTICK_CONTROL=\"JOYSTICK_CONTROL\"~%string VEHICLE_AVOIDANCE=\"VEHICLE_AVOIDANCE\"~%string OBSTACLE_AVOID=\"OBSTACLE_AVOID\"~%~%#List of states~%# LANE_FOLLOWING~%# COORDINATION	~%# INTERSECTION_CONTROL~%# JOYSTICK_CONTROL~%# VEHICLE_AVOIDANCE~%# OBSTACLE_AVOID~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FSMState)))
  "Returns full string definition for message of type 'FSMState"
  (cl:format cl:nil "Header header~%string state~%~%# pseudo constants~%string LANE_FOLLOWING=\"LANE_FOLLOWING\"~%string COORDINATION=\"COORDINATION\"	~%string INTERSECTION_CONTROL=\"INTERSECTION_CONTROL\"~%string JOYSTICK_CONTROL=\"JOYSTICK_CONTROL\"~%string VEHICLE_AVOIDANCE=\"VEHICLE_AVOIDANCE\"~%string OBSTACLE_AVOID=\"OBSTACLE_AVOID\"~%~%#List of states~%# LANE_FOLLOWING~%# COORDINATION	~%# INTERSECTION_CONTROL~%# JOYSTICK_CONTROL~%# VEHICLE_AVOIDANCE~%# OBSTACLE_AVOID~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
