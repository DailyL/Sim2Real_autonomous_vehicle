...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/dianzhaoli/duckie_catkin_ws/src/image_processing)
  set(image_processing_DEVEL_PREFIX /home/dianzhaoli/duckie_catkin_ws/devel)
  ...
  set(image_processing_INSTALL_PREFIX /home/dianzhaoli/duckie_catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dianzhaoli/duckie_catkin_ws/src/image_processing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT image_processing_NUM_DUMMY_TARGETS)
      set(image_processing_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::image_processing::wrapped-linker-option${image_processing_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR image_processing_NUM_DUMMY_TARGETS "${image_processing_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::image_processing::wrapped-linker-option${image_processing_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND image_processing_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(image_processing_EXPORTED_TARGETS ${${image_processing_dep}_EXPORTED_TARGETS})
endforeach()
