...
class WheelEncoderStamped {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.resolution, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WheelEncoderStamped(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [data]
    data.data = _deserializer.int32(buffer, bufferOffset);
    // Deserialize message field [resolution]
    data.resolution = _deserializer.uint16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new WheelEncoderStamped(null);
...
WheelEncoderStamped.Constants = {
  ENCODER_TYPE_ABSOLUTE: 0,
  ENCODER_TYPE_INCREMENTAL: 1,
}

module.exports = WheelEncoderStamped;
