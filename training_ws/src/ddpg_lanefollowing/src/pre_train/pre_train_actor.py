...
train_input = load("input_with_noise_NN.npy") 
...
def create_actor_network(state_size,action_dim):
        ...
        h0 = Dense(128, activation='relu',kernel_initializer="glorot_uniform",bias_initializer="zeros")(S)
        h1 = Dense(64, activation='relu',kernel_initializer="glorot_uniform", bias_initializer="zeros")(h0)
        vel = Dense(1,activation='sigmoid',kernel_initializer="glorot_uniform", bias_initializer="zeros")(h1)
        phi = Dense(1,activation='tanh',kernel_initializer="glorot_uniform", bias_initializer="zeros")(h1)
